...
├── _weixin_upload_worker.py    # 微信视频号上传子进程（async Playwright）
...
| B站           | 终端扫码 / biliup 弹窗 | `cookies/bilibili/account.json`       | 微信/QQ 扫码     |
| 微信视频号    | Playwright 浏览器弹窗   | `cookies/weixin/storage_state.json`   | 微信扫码         |
