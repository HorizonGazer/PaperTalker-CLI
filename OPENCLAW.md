...
**当你第一次接手这个项目时，严格按以下步骤操作，每一步都有验证方法。如果用户已经配置了环境，请务必认真检查依赖项，确保后续流程能完整跑通。**
...
*本文档由 OpenClaw Agent 生成和维护。最后更新: 2026-03-15*